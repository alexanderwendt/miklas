...
/**
 * The Top down designed mind shall survive optimally in the world. Everything it does, shall be top down programmed. It is ised as a 
 * benchmark for other minds.
 * 
 * @author wendt
 *
 */
public class TopdownDesignedMind implements ExternalMindControlInterface {

	private static final Logger log = LoggerFactory.getLogger(TopdownDesignedMind.class);
	...
	public TopdownDesignedMind(ExternalMindBodyInterface game) {
		gameMethods = game;
	...
	public void startCycle() {
		...
		ArrayList<String> attackableBodies = new ArrayList<String>(Arrays.asList("HUMANPLAYER","RANDOMPLAYER","ACTIONLESSPLAYER","ARSPLAYERTYPE", "FEEDERBODY"));
